...
\usepackage{booktabs}
\usepackage{multirow}
% Removed heavy packages: hyperref, xcolor, listings, titlesec, textcomp, subcaption for faster compilation
...
\begin{itemize}
    ...
    \item Flexibility and rapid pivoting are essential in development environments
...
\subsection{Visualization Images}
...
\begin{itemize}
    ...
    \item Successfully demonstrated system capabilities
...
\textbf{Challenge 1: Communication Protocol Development}
\begin{itemize}
    \item \textit{Issue:} Initial communication design needed optimization
    \item \textit{Solution:} Implemented robust TCP protocol with automatic reconnection
    \item \textit{Time Impact:} Improved reliability and reduced connection drops
\end{itemize}

\textbf{Challenge 2: Data Processing Algorithms}
\begin{itemize}
    \item \textit{Issue:} Achieving accurate DC offset removal and cycle looping
    \item \textit{Solution:} Developed rolling window analysis and interpolation algorithms
    \item \textit{Outcome:} Smooth, continuous waveform display without gaps
\end{itemize}
...
\begin{itemize}
    ...
    \item \textit{Solution:} Optimized rendering, reduced update rate to 10 FPS
...
\begin{itemize}
    \item Hardware team: ESP32 integration and voltage sensing
    \item Software team: Frontend and backend development
    \item Integration team: Testing and debugging
    \item Documentation team: Report and technical documentation
\end{itemize}
...
\subsection*{A.1 Complete System Schematic}
...
\textbf{Development Phase 4:}
\begin{itemize}
    \item Testing team: Comprehensive system validation
    \item All members: Documentation preparation
    \item Demo team: System demonstrations
    \item Documentation: Finalize technical reports
\end{itemize}
...
\subsection*{MCB Testing System Project}
